...
<div style="max-width:1280px">
  ...
  <div class="page-header" style="display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:12px;margin-bottom:22px">
    ...
    <div style="display:flex;gap:8px;align-items:center">
      <form method="POST" style="display:flex;gap:6px;align-items:center" onsubmit="startSync()">
        ...
        <button type="submit" id="syncBtn" class="btn btn-primary btn-sm" <?= (!$hasGmail||!$hasAI)?'disabled title="Configure Gmail + AI in Settings first"':'' ?>>
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" id="syncIcon"><path d="M23 4v6h-6M1 20v-6h6" stroke="#fff" stroke-width="2" stroke-linecap="round"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15" stroke="#fff" stroke-width="2" stroke-linecap="round"/></svg>
          <span id="syncLabel">Sync Gmail</span>
        </button>
      </form>
